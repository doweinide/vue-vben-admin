 ...
 * 菜单名称存在性检查验证模式
 */
export const MenuNameExistsSchema = z.object({
  // / 菜单名称（唯一）
 ...
 * 菜单路径存在性检查验证模式
 */
export const MenuPathExistsSchema = z.object({
  // / 路由路径（唯一，可为空）
  path: z
    .string()
    .min(1, '路由路径不能为空')
 ...
 * 菜单响应 Schema
 */
export const MenuResponseWrapperSchema = BaseResponseSchema.extend({
 ...
 * 创建菜单响应 Schema
 */
export const CreateMenuResponseSchema = BaseResponseSchema.extend({
  data: MenuResponseSchema,
});
 ...
 * 更新菜单响应 Schema
 */
export const UpdateMenuResponseSchema = BaseResponseSchema.extend({
  data: MenuResponseSchema,
});
 ...
 * 删除菜单响应 Schema
 */
export const DeleteMenuResponseSchema = BaseResponseSchema.extend({
  data: z.object({
    // / 删除成功消息
 ...
 */
export const PaginatedMenusResponseSchema =
...
export type MenuNameExistsDto = z.infer<typeof MenuNameExistsSchema>;
export type MenuPathExistsDto = z.infer<typeof MenuPathExistsSchema>;
export type MenuResponseDto = z.infer<typeof MenuResponseSchema>;
export type MenuMetaDto = z.infer<typeof MenuMetaSchema>;
export type MenuResponse = z.infer<typeof MenuResponseWrapperSchema>;
...
export type DeleteMenuResponse = z.infer<typeof DeleteMenuResponseSchema>;
export type PaginatedMenusResponse = z.infer<
  typeof PaginatedMenusResponseSchema
>;
